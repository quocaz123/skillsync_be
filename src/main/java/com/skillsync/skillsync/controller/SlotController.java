...
// public ApiResponse<List<SlotResponse>> getSlots(@PathVariable UUID
// teachingSkillId) {
// return
// ApiResponse.success(slotService.getSlotsByTeachingSkill(teachingSkillId));
// }

// /** GET /api/teaching-skills/{skillId}/slots/open — chỉ slot trống
// (public/learner) */
// @GetMapping("/{teachingSkillId}/slots/open")
// public ApiResponse<List<SlotResponse>> getOpenSlots(@PathVariable UUID
// teachingSkillId) {
// return
// ApiResponse.success(slotService.getOpenSlotsByTeachingSkill(teachingSkillId));
// }
...
// /** DELETE /api/teaching-skills/{skillId}/slots/{slotId} — xóa slot (chưa
// booked) */
// @DeleteMapping("/{teachingSkillId}/slots/{slotId}")
// public ApiResponse<Void> deleteSlot(@PathVariable UUID teachingSkillId,
