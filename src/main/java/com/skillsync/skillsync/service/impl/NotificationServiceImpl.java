...
public class NotificationServiceImpl implements NotificationService {
    ...
    public NotificationResponse createAndSend(NotificationCreateRequest request) {
        ...
        // STOMP payload sent to the specific user via their email address (used as Principal)
        try {
            // Queue format: /user/{email}/queue/notifications
            ...
            // Log but don't fail the transaction if WS fails
